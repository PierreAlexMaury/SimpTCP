...
char * makePDU (struct simptcp_socket * sockpdu, char * msg, unsigned char flags) {
	
	simptcp_set_sport (char * sockpdu->out_buffer, sockpdu->local_simptcp.syn_port);	
	simptcp_set_dport (char * sockpdu->out_buffer, sockpdu->remote_simptcp.syn_port);
	simptcp_set_flags  (char * sockpdu->out_buffer, unsigned char flags);
	simptcp_set_seq_num   (char * sockpdu->out_buffer, sockpdu->next_seq_num); //peut-être conflit de type
	simptcp_set_ack_num   (char * sockpdu->out_buffer, sockpdu->next_ack_num); //peut-être conflit de type
	simptcp_set_head_len   (char * sockpdu->out_buffer, sockpdu->out_len);  
	simptcp_set_total_len   (char * sockpdu->out_buffer, sockpdu->out_len);
...
void init_simptcp_socket(struct simptcp_socket *sock, unsigned int lport)
{
    ...
    unlock_simptcp_socket(sock);https://www.etud.insa-toulouse.fr/modules/gerer_svn/gerer_droits.php?depot=stcp-laloy-pamaury
